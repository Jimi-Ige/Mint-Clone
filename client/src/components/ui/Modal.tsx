...
export default function Modal({ open, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-gray-800 w-full sm:rounded-2xl rounded-t-2xl shadow-2xl sm:max-w-lg sm:mx-4 max-h-[95vh] sm:max-h-[90vh] overflow-auto animate-in">
